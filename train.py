...
def main(config):
    ...
    valid_data_loader = module_data.COWCGANFrcnnDataLoader('/content/DetectionPatches_256x256/Potsdam_ISPRS/HR/x4/',
    '/content/DetectionPatches_256x256/Potsdam_ISPRS/LR/x4/', 1, training = False)
